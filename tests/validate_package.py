...
REQUIRED_FILES = [
    ...
    "tests/hooks_selftest.sh",
    "hooks/protect_governing_files.py", "hooks/run_scope_gate_on_stop.py",
    "hooks/protected-paths.txt",
...
EXPECTED_TOP = {"README.md", "LICENSE", "CHANGELOG.md", "PROVENANCE.md",
                "HANDOFF.md", "install.py",
                "agent", "icm", "tests", "examples", "docs", "hooks"}
